...
def show_home(page: ft.Page, ir_bienvenida, ir_carrito=None, carrito_global=None, usuario=None, ir_perfil=None):
    page.clean()
    ...
    def toggle_favorito(producto):
        ...
        try:
            ...
            mostrar_snack("❤️ Agregado a favoritos" if prod_id in ids_favoritos["data"] else "💔 Eliminado de favoritos")
            page.update()
        except Exception as e:
    ...
    def abrir_producto(producto):
        ...
        def enviar_comentario(e):
            ...
            if ok:
                ...
                mostrar_snack("No se pudo publicar. Revisa si existe la tabla comentarios.")
                                    ...
                                    content=ft.Column(
                                        ...
                                        controls=[
                                            ...
                                            ft.Container(
                                                ...
                                                content=ft.Text("Añadir al carrito",
                                                                color="white",
                                                                weight=ft.FontWeight.BOLD),
                                            ),
                                        ],
    ...
    def construir_grid(productos, filtro="Todos", busqueda="", modo="Productos"):
        ...
        if not lista:
            icono = "❤️" if modo == "Favoritos" else "🔍"
    ...
    tabs_row = ft.Container(
        ...
        content=ft.Row(
            spacing=0,
            controls=[construir_tab(t) for t in tabs_data]
        )
    )
